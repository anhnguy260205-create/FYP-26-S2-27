...
def _holding_to_dict(holding: ExpertPortfolioHolding) -> Dict:
    return {
        ...
        "units_held": float(holding.units_held or 0),
        "avg_buy_price": float(holding.avg_buy_price or 0),
        "total_invested": float(holding.total_invested or 0),
        ...
        with get_session() as session:
            ...
            for item in holdings or []:
                ...
                session.add(ExpertPortfolioHolding(
                    ...
                    units_held=float(item.get("units_held") or 0),
