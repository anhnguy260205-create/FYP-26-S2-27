...
const emptyHolding = { ticker: "", company_name: "", allocation_pct: "", purchase_rationale: "" };
                  ...
                  {formData.holdings.map((holding, index) => (
                    <div key={index} className="rounded-2xl bg-white/[0.03] border border-white/10 p-5">
                      <div className="grid grid-cols-1 md:grid-cols-12 gap-4 mb-4">
                        ...
                        <div className="md:col-span-4"><Field label="Company Name" value={holding.company_name} onChange={(v) => updateHolding(index, "company_name", v)} placeholder="Apple Inc." /></div>
                        <div className="md:col-span-3"><Field label="Allocation % *" type="number" value={holding.allocation_pct} onChange={(v) => updateHolding(index, "allocation_pct", v)} placeholder="20" /></div>
