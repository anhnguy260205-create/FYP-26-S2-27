...
import { Star, ThumbsUp, Pencil, Trash2, Check, X, Flag } from "lucide-react";
import GeneralHeader from "../../layout/GeneralHeader.jsx";
import ConsultantHeader from "../../layout/ConsultantHeader.jsx";
import Footer from "../../layout/Footer.jsx";
import {
  createReview, deleteReview, flagReview, getMyReview,
  getReviewStats, getReviews, toggleReviewHelpful, updateReview,
...
export default function ReviewsPage() {
  ...
  async function handleReport(review, reason) {
    ...
    try {
      ...
      if (data?.success) {
        // Toggle flagged_by_me optimistically
