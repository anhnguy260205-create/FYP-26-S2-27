...
import { Shield, User, ChartNoAxesColumn, SquarePen, Star, Briefcase } from "lucide-react";
...
function LeftSection({ activeTab, setActiveTab, expertInfo, currentUser }) {
    ...
    const expertStatus = expertInfo?.expert_status?.toLowerCase();
        ...
        <div className="flex flex-col shrink-0" style={{ gap: "16px" }}>
            ...
            <div style={{ position: "relative", height: "78px", background: "linear-gradient(135deg,#020618 0%,#0d2d5e 45%,#0092b8 100%)", overflow: "hidden" }}>
                ...
                <div style={{ position: "absolute", top: "9px", right: "9px", padding: "2px 9px", borderRadius: "100px", background: "rgba(0,0,0,0.35)", fontSize: "10px", fontWeight: 700, backdropFilter: "blur(8px)", ...statusStyle }}>
                    ★ {expertInfo?.expert_status || "Active"}
                </div>
            </div>
